...
namespace Data_Analysis
{
    ...
    class IntervalRow : IRowInterval
    {
        ...
        /*Метод для заповнення даними з CSV файла списку RowList*/
        ...
        /*Метод для заповнення списку IntervalGrid, для подальшого заповнення DataGrid у IntervalControl*/
        ...
        public double CalculateAverageValue()
        {
            try
            {
                ...
                {
                    AverageValue += (Convert.ToDouble(lBorder[i]) + (((Convert.ToDouble(rBorder[i])) 
                        - (Convert.ToDouble(lBorder[i]))) / 2)) * Convert.ToDouble(freq[i]);
                }
                AverageValue = AverageValue / RowList.Count;
                return Math.Round(AverageValue, 2);
            }
            catch { return Math.Round(AverageValue, 2); }
        }
        ...
        public double CalculateMode()
        {
            ...
            catch { return Math.Round(Mode, 2); }
        }
        ...
        public double CalculateMedia()
        {
            ...
            try
            {
                ...
                for (int i = 1; i < IntervalGrid.Count - 1; i++)
                {
                    ...
                    {
                        if ((Convert.ToDouble(lBorder[i])) <= (RowList.Count / 2) && 
                            (RowList.Count / 2) >= (Convert.ToDouble(rBorder[i])))
                        {
                            Median = (Convert.ToDouble(lBorder[i])) + (H * ((RowList.Count / 2) - 
                                (Convert.ToDouble(accumFreq[i - 1]))) / (Convert.ToDouble(freq[i])));
                        }
                        else break;
                    }
                    else break;
                    ...
                    {
                        if ((Convert.ToDouble(lBorder[i])) <= (RowList.Count / 2) && (RowList.Count / 2) 
                            >= (Convert.ToDouble(rBorder[i])))
                        {
                            Median = (Convert.ToDouble(lBorder[i])) + (H * ((RowList.Count / 2) - 
                                (Convert.ToDouble(accumFreq[i - 1]))) / (Convert.ToDouble(freq[i])));
                        }
        ...
        /*Метод для пошуку розмаху варіації*/
        ...
        public double CalculateMeanLinearDeviation()
        {
            ...
            try
            {
                for (int i = 1; i < IntervalGrid.Count - 1; i++)
                {
                    MeanLinearDeviation += (Math.Abs((((Convert.ToDouble(lBorder[i])) + ((Convert.ToDouble(rBorder[i])) - 
                        (Convert.ToDouble(lBorder[i])))) / 2) / AverageValue) * (Convert.ToDouble(freq[i]))) / RowList.Count;
                }
        ...
        public double CalculateDispersion()
        {
            ...
            try
            {
                ...
                for (int i = 1; i < IntervalGrid.Count - 1; i++)
                {
                    Dispersion += ((Math.Pow(((((Convert.ToDouble(lBorder[i])) + ((Convert.ToDouble(rBorder[i])) - 
                        (Convert.ToDouble(lBorder[i])))) / 2) / AverageValue), 2)) * (Convert.ToDouble(freq[i]))) / RowList.Count;
                }
        ...
        /*Метод пошуку середнього квадратичного відхилення*/
        ...
        /*Метод пошуку коефіцієнта варіації*/
        ...
        /*Метод для пошуку нормованого моментного коефіцієнта асиметрії та його оцінки*/
        public double CalculateNormalCoefficientAsymmetry()
        {
            ...
            try
            {
                ...
                for (int i = 1; i < IntervalGrid.Count - 1; i++)
                {
                    Mom += Math.Abs(((Math.Pow(((((Convert.ToDouble(lBorder[i])) + ((Convert.ToDouble(rBorder[i])) - 
                        (Convert.ToDouble(lBorder[i])))) / 2) / AverageValue), 3))) * (Convert.ToDouble(freq[i]))) / RowList.Count;
                }
        ...
        public double CalculateExcess()
        {
            ...
            try
            {
                ...
                for (int i = 1; i < IntervalGrid.Count - 1; i++)
                {
                    mom = ((Math.Pow(((((Convert.ToDouble(lBorder[i])) + ((Convert.ToDouble(rBorder[i])) - 
                        (Convert.ToDouble(lBorder[i])))) / 2) / AverageValue), 4)) * (Convert.ToDouble(freq[i]))) / RowList.Count;
                }
